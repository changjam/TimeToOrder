        ...
        <div class="group-container">
            <div v-if="showCreateGroupForm">
                ...
                <div v-for="(email, index) in emails" :key="index" class="form-group">
                    ...
                    <input v-if="index == 0" :id="'email' + index" type="email" :value="email" class="input-field"
                        disabled />
                    <input v-else v-model="emails[index]" :id="'email' + index" type="email" placeholder="輸入成員信箱"
                        class="input-field" />
                </div>
