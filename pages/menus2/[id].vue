...
import { classifyDishes } from '@/utils/menus/menuHandler';

const route = useRoute();

const _id = route.fullPath.match(/\/menus2\/(.+)/)[1];
const dish_search = await useFetch('/api/menus/get', {
  params: {
    _id: _id,
  },
});

const dishes = dish_search.data.value.data;
const classifiedDishes = classifyDishes(dishes);
const categories = Object.keys(classifiedDishes);
